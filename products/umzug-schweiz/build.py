...
TASKS = [
    ...
    (0, "Abmeldung bei der alten Gemeinde – spätestens am Umzugstag (in vielen Gemeinden online via eUmzugCH, zusammen mit der Anmeldung).",
     "Deregister at your old commune – at the latest on moving day (online via eUmzugCH in many communes, together with registering)."),
